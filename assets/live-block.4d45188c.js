import{_ as c}from"./index.abe9f35c.js";import{g as m,R as e}from"./vendor.d396be56.js";function d(l={}){const{wrapper:t}=Object.assign({},m(),l.components);return t?e.createElement(t,l,e.createElement(a)):a();function a(){const n=Object.assign({h1:"h1",p:"p",code:"code",blockquote:"blockquote",h3:"h3",pre:"pre",span:"span",h2:"h2"},m(),l.components),{ShowCode:o}=n;return o||r("ShowCode",!0),e.createElement(e.Fragment,null,e.createElement(n.h1,{id:"live-block"},"Live Block"),`
...
`,e.createElement(n.p,null,"Docit provides a ",e.createElement(n.code,null,"360 * 640")," mobile view to help you display responsive component"))}}function r(l,t){throw new Error("Expected "+(t?"component":"object")+" `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as default};
