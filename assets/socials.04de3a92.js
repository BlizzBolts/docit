import{g as c,R as e}from"./vendor.d396be56.js";function o(n={}){const{wrapper:l}=Object.assign({},c(),n.components);return l?e.createElement(l,n,e.createElement(a)):a();function a(){const t=Object.assign({h1:"h1",p:"p",code:"code",blockquote:"blockquote",a:"a",h2:"h2",pre:"pre",span:"span"},c(),n.components);return e.createElement(e.Fragment,null,e.createElement(t.h1,null,"Socials"),`
...
`,e.createElement(t.h2,null,"Example"),`
...
`,e.createElement(t.span,{className:"hljs-keyword"},"export")," ",e.createElement(t.span,{className:"hljs-keyword"},"default"),` {
  `,e.createElement(t.span,{className:"hljs-attr"},"socials"),`: {
    `,e.createElement(t.span,{className:"hljs-title hljs-class"},"Github"),": ",e.createElement(t.span,{className:"hljs-string"},"'https://github.com/phshy0607/docit'"),`
  }
}
`)))}}export{o as default};
