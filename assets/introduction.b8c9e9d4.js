import{u as a,R as e}from"./index.b0548d52.js";function l(n){const t=Object.assign({h1:"h1",p:"p",strong:"strong",a:"a",ul:"ul",li:"li",h2:"h2",blockquote:"blockquote",pre:"pre",code:"code",h3:"h3",ol:"ol",span:"span"},a(),n.components);return e.createElement(e.Fragment,null,e.createElement(t.h1,{id:"docit"},"Docit"),`
`,e.createElement(t.p,null,e.createElement(t.strong,null,"A markdown first react documentation solution ",e.createElement(t.a,{href:"https://blizzbolts.github.io/docit"},"https://blizzbolts.github.io/docit"))),`
`,e.createElement(t.ul,null,`
`,e.createElement(t.li,null,"\u{1F61B} MDX & MD Syntax oriented. No Noisy JSX!"),`
...
`,e.createElement(t.p,null,"Current site is powered by Docit!."),`
...
`),`
`,e.createElement(t.h2,{id:"installation"},"Installation"),`
...
`,e.createElement(t.h2,{id:"examples-1"},"Examples"),`
`,e.createElement(t.p,null,e.createElement(t.a,{href:"https://blizzbolts.github.io/docit/"},"Docit")))}function o(n={}){const{wrapper:t}=Object.assign({},a(),n.components);return t?e.createElement(t,n,e.createElement(l,n)):l(n)}export{o as default};
