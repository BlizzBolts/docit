...
<table>
  ...
  <tr>
    <td>
      Note that Markdown formatting syntax is not processed within block-level HTML tags. E.g., you
      can’t use Markdown-style *emphasis* inside an HTML block.
    </td>
  </tr>
</table>
...
Note that GitHub Flavored Markdown has URL autolinking, which will _not_
...
- ![Alt text][img]
- <img
    src="https://raw.githubusercontent.com/joeyespo/grip/master/artwork/favicon.ico"
    width="32"
    height="32"
  /> &nbsp; &larr; bigger &amp; blurrier
...
_TODO: Test all allowed HTML tags._
